...
| Option | Why not |
|--------|---------|
| Keep flat text only | Root cause of merged words and poor MCP content |
| Markdown only (replace HTML) | Loses direct offline browsing without a Markdown viewer |
