...
The Go backend needs a configuration file for database connections, encryption keys, scraper settings, and embedding model selection.

## Decision

Use YAML (`gopkg.in/yaml.v3`) for the configuration file.
